...
export const NODE_DATA_FOLDER_MAIN_NETWORK = getConstValue('DATA_BASE_DIR_MAIN_NETWORK');
export const NODE_DATA_FOLDER_TEST_NETWORK = getConstValue('DATA_BASE_DIR_TEST_NETWORK');
